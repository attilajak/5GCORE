...
def index():
	...
	return render_template('basic.html',regsuccess=registration_status,pdusuccess=pdu_session_status,deregsuccess=deregistration_status,sessblobsuccess=sess_blob_status,notificationsuccess=notification_status)
...
def RegisterReq():
    ...
    recordexists = ldapc.search_s(search_dn,ldap.SCOPE_SUBTREE)
    print(recordexists)
...
@app.route('/sessionblobdata',methods=['POST'])
def SessBlobReq():
    global enp0s3Ip
    global pdu_session_status
    global registration_status
