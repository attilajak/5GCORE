...
class SMContextModify(Resource):
    ...
    def post(self,supi):
		...
		print(CurrentPath+":59   [SMF][INFO]   "+"Receved SmModifyContextData From PCF")
		print(CurrentPath+":60   [SMF][INFO]   "+"Handling SM Context Update Notify From PCF ...")
		#post N1N2 transfer message to amf
		print(CurrentPath+":39   [SMF][INFO]   "+"transfer n1n2messages to AMF")
		print(CurrentPath+":40   [SMF][INFO]   "+"call AMF N1N2MessagesTransfer operation")
		print(CurrentPath+":36   [SMF][INFO]   "+"post http://127.0.0.1:5001/namf-comm/v1/208930000000001/n1-n2-messages")
		N1N2MsgTransfer = "http://127.0.0.1:5001/namf-comm/v1/777777/n1-n2-messages"
		MsgSMF2UE = {"AllocatedUEIp":"172.16.0.3","CNTunnelID":"75757575","UPFURI":"abhchh"}
		r1 = requests.post(N1N2MsgTransfer,data=MsgSMF2UE)
		if r1.status_code == 200:
			print(CurrentPath+":41   [SMF][INFO]   SMF SEND BEARER INFO TO AMF")
			# Post update to UPF
			print(CurrentPath+":31   [SMF][INFO]   "+"SMF SENDS N4 SESSION MODIFICATION REQUEST TO UPF")
			print(CurrentPath+":32   [SMF][INFO]   "+"post http://127.0.0.1:5012/nupf/v1/UpfSmfInterface")
			N4SessionModifyReq = "http://127.0.0.1:5012/nupf/v1/UpfSmfInterface"
			...
			r = requests.post(N4SessionModifyReq,data=N4SessionMsg)
			if r.status_code == 200:
				print(CurrentPath+":37   [SMF][INFO]   "+"SMF RECEIVES N4 SESSION MODIFICATION RESPONSE FROM UPF")
				return "SmModifyContextData Success",200
